...
class ReplayBuffer:
    def __init__(self, config, state_shape):
        ...
        self.size = config.marl.buffer_size
        ...
        self.buffers = {
                        ...
                        'u': np.empty([self.size, self.n_steps, self.n_agents, 1]),
                        's': np.empty([self.size, self.n_steps, self.n_agents, self.state_shape]),
                        'r': np.empty([self.size, self.n_steps, 1]),
                        # 'o_next': np.empty([self.size, self.episode_limit, self.n_agents, self.obs_shape]),
                        's_next': np.empty([self.size, self.n_steps, self.n_agents, self.state_shape]),
                        ...
                        'u_onehot': np.empty([self.size, self.n_steps, self.n_agents, self.n_actions]),
